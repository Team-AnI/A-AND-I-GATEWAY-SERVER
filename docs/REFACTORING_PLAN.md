...
| 4 | route와 보안 정책 source of truth 단일화 | 4A, 4B-1 완료; 4B-2 다음 | 실제 route 선택과 route별 선언 method 도달성 검사 후 typed contract로 단계적 전환 |
...
#### 4B-2: Auth endpoint policy/access catalog — 다음
