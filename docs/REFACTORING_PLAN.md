...
| 5 | Monitor Bot 대형 모듈 분리 | 5A, 5B, 5C-a, 5C-b1~b3, 5C-b4a 완료; 5C-b4b 다음 | 동작 변경 없는 파일 분리 후 Go 전체 테스트와 race 통과 |
...
### 5C-b4b: logs watch command family 분리 — 다음
...
### 5C-b5: remaining interaction command family 분리 — 계획
