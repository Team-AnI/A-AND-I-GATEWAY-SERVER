    ...
    fun authenticatedSecurityFilterChain(
        ...
        return http
            ...
            .authorizeExchange {
                ...
                it.pathMatchers(HttpMethod.GET, "/v2/posts/drafts", "/v2/posts/drafts/**").hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.GET, "/v2/posts/me").hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.GET, "/v1/posts", "/v1/posts/*", "/v2/post", "/v2/post/*", "/v2/posts", "/v2/posts/*").permitAll()
                it.pathMatchers(HttpMethod.POST, "/v1/posts", "/v2/post", "/v2/posts").hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.PATCH, "/v1/posts/*", "/v2/post/*", "/v2/posts/*").hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.DELETE, "/v1/posts/*", "/v2/post/*", "/v2/posts/*").hasAnyRole("ORGANIZER", "ADMIN")
