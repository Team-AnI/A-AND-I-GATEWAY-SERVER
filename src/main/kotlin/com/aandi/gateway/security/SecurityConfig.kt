        ...
        return http
            ...
            .authorizeExchange {
                ...
                it.pathMatchers(HttpMethod.GET, "/v2/posts/drafts", "/v2/posts/drafts/**", "/v2/blogs/drafts", "/v2/blogs/drafts/**", "/v2/lectures/drafts", "/v2/lectures/drafts/**")
                    .hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.GET, "/v2/posts/me", "/v2/blogs/me", "/v2/lectures/me").hasAnyRole("ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.GET, "/v2/lectures", "/v2/lectures/*").hasAnyRole("USER", "ORGANIZER", "ADMIN")
                it.pathMatchers(HttpMethod.GET, "/v1/posts", "/v1/posts/*", "/v2/post", "/v2/post/*", "/v2/posts", "/v2/posts/*", "/v2/blogs", "/v2/blogs/*").permitAll()
