...
- `/ops dashboard since:<5m|15m|30m|1h|3h>`
- `/ops service service:<gateway|auth|report|online-judge|post> view:<summary|health|copy>`
- `/ops logs service:<service|all> mode:<recent|errors|top|slow> level:<INFO|WARN|ERROR> limit:<5|10|20>`
- `/ops copy since:<5m|15m|30m|1h|3h>`
