...
- `/status`
- `/health service:<gateway|auth|report|online-judge|post>`
- `/logs service:<service> since:<5m|15m|30m|1h|3h> level:<INFO|WARN|ERROR>`
- `/errors service:<optional> since:<duration>`
