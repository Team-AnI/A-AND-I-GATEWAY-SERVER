...
- `/ops assignment course:<course> id:<assignmentId> action:ack event:<eventType> until:7d reason:<reason>`으로 의도된 stale issue를 silence할 수 있습니다.
